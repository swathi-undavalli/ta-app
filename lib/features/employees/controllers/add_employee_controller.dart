  ...
  createEmployee() async {
    ...
    if (controller.firstNameTED.text != '' &&
      ...
      Employee employee = Employee(
        firstName: controller.firstNameTED.text.trim().capitalizeFirst,
        lastName: controller.lastNameTED.text.trim().capitalizeFirst,
        nickName: controller.nickNameTED.text.trim().capitalizeFirst,
...
class AddAnEmployeeController extends GetxController {
  ...
  TextEditingController nickNameTED = TextEditingController();
