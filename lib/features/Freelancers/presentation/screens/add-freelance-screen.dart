...
class AddFreelanceScreen extends StatelessWidget {
  ...
  final FreelanceLogic logic = FreelanceLogic();
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 10),
                        Text(
                          "Last Employee ID : ${counterModel.freelance.toString()}",
                          style: TextStyle(
  ...
  Widget buildAccessLevels() {
    return GetBuilder<FreelanceController>(builder: (controller) {
      return Column(
        children: [
          buildSwitch(
              text: "View Bookings",
  ...
  Widget buildEmployeeID() {
    return Padding(
      ...
      child: AppTextField(
        width: 320,
        hintText: 'Freelance ID',
        controller: logic.controller.freelanceIdTED,
        focusNode: logic.controller.freelanceIdNode,
  ...
  Widget buildSubmitButton() {
    return Center(
      child: AppButton.flat(
        ...
        onTap: () {
          if (isEdit)
            logic.updateFreelance();
          else {
            log("clicked");
            logic.createFreelance();
          }
        },
      ),
    );
