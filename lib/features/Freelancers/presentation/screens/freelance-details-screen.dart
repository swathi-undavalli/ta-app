...
class FreelanceDetailsScreen extends StatelessWidget {
  ...
  FreelanceLogic logic = FreelanceLogic();

  @override
  Widget build(BuildContext context) {
    final DateTime date = freelanceArgument.shiftTiming;
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    buildIcons(
                      Icons.call_rounded,
                          () {
                        makingPhoneCall(freelanceArgument.phoneNumber,
                            freelanceArgument.countryCode);
                      },
                    ),
                    EmployeeAccess(
                      ...
                      child: buildIcons(Icons.edit, () async {
                        if (await checkFirebase()) {
                          ...
                          Get.toNamed(AddFreelanceScreen.id, arguments: true);
                        }
                      }),
                    ),
                    EmployeeAccess(
                                ...
                                AppButton.miniFlat(
                                  ...
                                  onTap: () {
                                    ...
                                    LogModel logModel = LogModel(
                                      ...
                                      employeeName: freelanceArgument.name,
                                    );
                                    FirebaseFirestore.instance
                                        .collection("logs")
                                        .doc()
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      buildEmployeeInfo(
                          subHeading: "Name", text: freelanceArgument.firstName),
                      buildEmployeeInfo(
                          subHeading: "Phone Number",
                          text: freelanceArgument.countryCode +
                              freelanceArgument.phoneNumber),
                      buildEmployeeInfo(
                          subHeading: "ShiftTiming", text: shiftTiming),
                      buildEmployeeInfo(
                          subHeading: "Role", text: freelanceArgument.role),
                    ],
                  ),
                ),
                SizedBox(height: 20),
