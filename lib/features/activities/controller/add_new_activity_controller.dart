...
class AddNewActivityLogic {
  ...
  onSubmit(BuildContext context) async {
    ...
    if (controller.nameTED.text != '' &&
      ...
      FirebaseFirestore.instance.collection('catalogue').doc(activityModel.id).set(activityModel.toMap());
      ...
      LogModel logModel = LogModel(type: LogType.addActivity, activityName: activityModel.name);
