...
class ManageGeneralInfoLogic {
  ManageGeneralInfoController controller = Get.put(ManageGeneralInfoController());
  ...
  Future<void> init() async {
    ...
    if (boatsModel.dsd == null) {
      ...
      controller.highTideTime = TimePicker.getDateTime(controller.currentDsd.highTides) ?? DateTime.now();
      controller.lowTideTime = TimePicker.getDateTime(controller.currentDsd.lowTides) ?? DateTime.now();
      controller.generalNotesTED.text = controller.currentDsd.generalNotes ?? '';
