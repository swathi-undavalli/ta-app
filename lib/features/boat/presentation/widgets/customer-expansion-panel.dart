...
class _CustomersExpansionPanelState extends State<CustomersExpansionPanel> {
                  ...
                  InkWell(
                    onTap: () async {
                      List<Instructor>? instructors =
                        ...
                        context,
                        initialSelectedEmployees: itemModel.bookingModel
                                ?.getBoatDetails(widget.selectedDate)
                                ?.instructors ??
                            [],
                      );
                ...
                children: [
                  ...
                  BoatSelector(
                    ...
                    onChanged: (List<String> boatDetails) async {
                      await updateBoatDetails(
                          bookingModel: bookingModel,
                          boatId: boatDetails[0],
                          boatName: boatDetails[1],
                          selectedDate: widget.selectedDate);
                    },
                    selectedDate: widget.selectedDate,
                  ),
  ...
  Future<void> updateBoatDetails({
    ...
    if (bookingStatus != null) {
      ...
      log(instructors?.toList().toString() ?? "empty");
      log(boatDetails?.toMap().toString() ?? "");
