...
import '../../controller/manage_general_info_controller.dart';
import '../../models/boat_details.dart';
import '../widgets/counter_widget.dart';
import '../widgets/employee_selector_bottom_sheet.dart';
...
class ManageGeneralInfo extends StatefulWidget {
  ...
  const ManageGeneralInfo({Key? key}) : super(key: key);
          ...
          data: Theme.of(context).copyWith(
            ...
            textButtonTheme: TextButtonThemeData(
              style: TextButton.styleFrom(
                ...
                textStyle:
                    const TextStyle(fontWeight: FontWeight.w500), // button text color
              ),
            ),
          ),
          child: child!,
