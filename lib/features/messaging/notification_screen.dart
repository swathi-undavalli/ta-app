                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Hurrah !!',
                              style:
                                  TextStyle(fontSize: 30, fontWeight: FontWeight.w600, color: AppColors.text.skyBlue),
                            ),
                            ...
                            buildBookingDetails(
                              title: 'Balance',
                              text:
                                  '${((controller.bookingModel?.totalCost ?? 0) - (controller.bookingModel?.paid ?? 0)).toStringAsFixed(0)}/-',
                            ),
