            ...
            if (showDetails && !isBookingScreen)
              StreamBuilder(
                  ...
                  builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot) {
                    ...
                    BoatsModel? boatsModel = BoatsModel.fromJson(data as Map<String, dynamic>);
                                      ...
                                      child: Center(
                                        child: Text(
                                          ...
                                          style: TextStyle(
                                            ...
                                            color:
                                                (boat.id == controller.selectedBoat?.id) ? Colors.white : Colors.black,
                                          ),
                                        ),
                                      ),
                                    ),
      ...
      if (showDetails && isBookingScreen)
        ...
        if (controller.selectedBoat != null) {
          bookingExpansionList.forEach((itemModel) {
            if (itemModel.bookingModel?.getBoatInfo(controller.selectedDate) == (controller.selectedBoat?.id ?? "-")) {
